...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $banner_search; ?>);">
    ...
    <div class="inner">
        <h1>
            Search By: 
            <?php 
                $search_text = strip_tags(myTrim($_REQUEST['search_text'])); 
                echo $search_text; 
            ?>            
        </h1>
    </div>
...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            //$statement->execute(array(1,$search_text));
            //$result = $statement->fetchAll(PDO::FETCH_ASSOC);
            $query = "SELECT * FROM tbl_product WHERE p_is_active= '".$search_text."s' LIMIT $start, $limit";
            $result = queryMysql($query, $pdo);
